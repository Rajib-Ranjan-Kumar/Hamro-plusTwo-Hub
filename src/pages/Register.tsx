...
export const Register = () => {
  ...
  return (
    <div className="min-h-screen flex bg-slate-900 text-white font-sans selection:bg-emerald-500/30">
      {/* Left Side - Image */}
      <motion.div 
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-slate-900/20 via-slate-900/60 to-slate-900 z-10"></div>
        <img 
        ...
        <div className="relative z-20 flex flex-col justify-end p-12 h-full">
          <h1 className="text-4xl font-bold text-white mb-4">Join Hamro +2 Hub</h1>
      ...
      <motion.div 
        ...
        className="w-full lg:w-1/2 flex flex-col p-8 sm:p-12 lg:p-24 justify-center relative overflow-y-auto"
      >
        <div className="absolute top-8 right-8 flex items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold tracking-tight">Hamro +2</span>
          </div>
        </div>

        <div className="max-w-md w-full mx-auto mt-12 lg:mt-0">
          <h2 className="text-3xl font-bold text-white mb-2">Create an Account</h2>
          <p className="text-slate-400 mb-8">Join thousands of +2 students in Nepal.</p>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-slate-800 hover:bg-slate-50 text-white font-medium rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSubmitting ? (
