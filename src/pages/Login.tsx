    ...
    <div className="min-h-screen flex bg-slate-900 text-white font-sans selection:bg-emerald-500/30">
      ...
      >
        ...
        <div className="relative z-20 flex flex-col justify-end p-12 h-full">
          <h1 className="text-4xl font-bold text-white mb-4">Hamro +2 Hub</h1>
      ...
      <motion.div 
        ...
        className="w-full lg:w-1/2 flex flex-col p-8 sm:p-12 lg:p-24 justify-center relative"
      >
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <p className="text-slate-400 mb-8">Sign in to access your study materials.</p>
